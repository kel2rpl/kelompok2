                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Kategori Makeup</li>
                        </ol>
                    </div>
                </div>
            </div>
                        ...
                        @card
                            ...
                            <form role="form" action="{{ route('kategori.store') }}" method="POST">
                                ...
                                <div class="form-group">
                                    <label for="name">Kategori Makeup</label>
                                    <input type="text" 
                                    name="name_makeup"
                                    class="form-control {{ $errors->has('name_makeup') ? 'is-invalid':'' }}" id="name_makeup" required>
                                </div>
                                <div class="form-group">
                                    <label for="description">Deskripsi Makeup</label>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    <thead>
                                        <tr>
                                            <td>#</td>
                                            <td>Kategori Makeup</td>
                                            <td>Deskripsi Makeup</td>
                                            <td>Aksi</td>
                                        </tr>
                                    </thead>
                                    <tbody>
